...
public class Optional {
    public static void main(String[] args) {
        ...
        java.util.Optional<String> optVal1 = java.util.Optional.of("abc");
        // Optional<String> optVal2 = Optional.of(null); // NullPointerExcetion발생
        java.util.Optional<String> optVal3 = java.util.Optional.ofNullable(null); // OK

        /**
         * Null 대신 빈 Optional<T> 객체를 사용해야 함
         */
        java.util.Optional<String> optVal4 = null; // null 초기화, 바람직하지않음
        java.util.Optional<String> optVal5 = java.util.Optional.empty(); // 빈 객체로 초기화

        /*******************************************************************
         * Optional<T> 객체의 값 가져오기
         * get(), orElse(), orElseGet(), orElseThrow()
         *******************************************************************/
        java.util.Optional<String> optVal6 = java.util.Optional.of("abc");
         ...
         */
        str = "abc";
        if(java.util.Optional.ofNullable(str).isPresent()){
...
//        Optional.ofNullable(str2).ifPresent(System.out::println); // 람다식
        java.util.Optional.ofNullable(str2).ifPresent((v) -> System.out.println(v));
...
//        str = opt.orElseGet(() -> new String());
         ...
         * 실습
         *******************************************************************/
        java.util.Optional<String> optStr = java.util.Optional.of("abcde");
//        Optional<Integer> optInt = optStr.map(String::length);
        java.util.Optional<Integer> optInt = optStr.map(s -> s.length());
        System.out.println("optStr = " + optStr.get());
        System.out.println("optInt = " + optInt.get());

        int result1 = java.util.Optional.of("123")
                            .filter(x -> x.length() > 0)
                            .map(Integer::parseInt).get();

        int result2 = java.util.Optional.of("")
                .filter(x -> x.length() > 0)
        ...
        java.util.Optional.of("456").map(Integer::parseInt)
