...
public class ch14_50_스트림의그룹화와분할01 {
    public static void main(String[] args) {
        /*******************************************************************
         * partitioningBy()
         * 스트림 요소를 2분할 그룹화
         *******************************************************************/
        Student2[] stuArr = new Student2[]{
                new Student2("안자바", true, 1, 1,  300),
                new Student2("이자바", false, 1, 1, 250),
                new Student2("박자바", true, 1, 2, 200),
                new Student2("소자바", true, 1, 3, 150),
                new Student2("김자바", false, 1, 3,  50),
                new Student2("나자바", true, 2, 1, 100),
                new Student2("여자바", false, 2, 1, 200),
                new Student2("님자바", false, 2, 2, 150),
                new Student2("황자바", true, 2, 2, 250),
                new Student2("하자바", false, 3, 3, 100)
        };
        ...
        List<Student2> maleStudent = stuBySex.get(true); // 남자만 반환
        List<Student2> femaleStudent = stuBySex.get(false); // 여자만 반환
