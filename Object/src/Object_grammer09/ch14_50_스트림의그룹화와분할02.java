...
public class ch14_50_스트림의그룹화와분할02 {
    public static void main(String[] args) {
        Student3[] stuArr = new Student3[]{
                new Student3("안자바", true, 1, 1,  300),
                new Student3("이자바", false, 1, 1, 250),
                new Student3("박자바", true, 1, 2, 200),
                new Student3("소자바", true, 1, 3, 150),
                new Student3("김자바", false, 1, 3,  50),
                new Student3("나자바", true, 2, 1, 100),
                new Student3("여자바", false, 2, 1, 200),
                new Student3("님자바", false, 2, 2, 150),
                new Student3("황자바", true, 2, 2, 250),
                new Student3("하자바", false, 3, 3, 100)
        };
